...
/**
 * The RL/sim-to-real and world-model interactives are explanatory
 ...
 * interactive an rl-sim2real or world-models article imports from
...
const INSTRUMENT_DOMAINS = new Set(['rl-sim2real', 'world-models']);
...
describe('RL/world-model instruments use the shared instrument family', () => {
