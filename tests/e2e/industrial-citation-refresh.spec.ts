...
test('industrial closure paired cases and complete reader surfaces', async ({ page }) => {
  ...
  if (producing) save('browser-run.json', {
    command: 'NODE_DISABLE_COMPILE_CACHE=1 INDUSTRIAL_WRITE_BROWSER=1 node_modules/.bin/playwright test --config steward-runs/20260924-0540-industrial.config.mjs',
