...
import { ARTICLE, BROWSER, DIRECTORY, artifact, defaults, dependencies, oracle, save, surfacePaths } from '../../audit/evidence/residual-release-20260924/support';
...
test('industrial closure paired cases and complete reader surfaces', async ({ page }) => {
  ...
  if (producing) save('browser-run.json', {
    command: 'NODE_DISABLE_COMPILE_CACHE=1 INDUSTRIAL_WRITE_BROWSER=1 node_modules/.bin/playwright test --config /home/remy-simpc4/.local/share/robot-wiki-codex-bridge/steward-runs/20260924-0140-browser.config.mjs',
