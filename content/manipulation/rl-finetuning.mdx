...
The [comparison matrix](/manipulation/comparison-matrix) places these methods against the imitation-only baselines they build on, and [the pi line](/manipulation/pi-line) traces how Recap grew out of the pi0.6 architecture and was later distilled back into pi0.7's single generalist.
