...
The [comparison matrix](/manipulation/comparison-matrix) tabulates which policy uses which strategy, and the [generalist policies module](/manipulation/generalist-policies) covers the labs' broader release landscape. The [pi line module](/manipulation/pi-line) traces how the pi family's own answer evolved from pi0 to pi0.7.
