...
The pooled data is of heterogeneous quality: one widely read critique calls it an open secret that OXE is mostly low-quality data, with no good methods yet to quantify data quality in imitation learning <Cite id="oxe-quality-critique-2026" />.
