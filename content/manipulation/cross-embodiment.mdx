...
All three answers are rendered below on the same four data sources at identical geometry. Switch between the padded shared vector, motion transfer, and shared relative end-effector space, and watch the bottom row: human video is unusable in two of the three and fully active in the third.
