...
The [comparison matrix](/manipulation/comparison-matrix) encodes this shift as the hierarchy axis across all of the methods in the wiki, and [the pi line](/manipulation/pi-line) traces how one lab moved from Hi Robot's two networks to π0.5's single pass in about a year.
