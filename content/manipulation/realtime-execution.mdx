...
The [pi line module](/manipulation/pi-line) traces how the step count and the RTC machinery evolved across the pi0 family, and the [comparison matrix](/manipulation/comparison-matrix) puts the resulting inference costs next to the other method families.
