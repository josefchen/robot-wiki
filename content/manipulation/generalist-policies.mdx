...
Figure’s February 20, 2025 Helix announcement describes two coupled systems: S2, an internet-pretrained VLM operating at 7 to 9 Hz, produces a continuous latent vector; S1, a latent-conditioned visuomotor transformer, generates upper-body control at 200 Hz. The described outputs include desired wrist poses, finger controls, and torso and head orientation targets, not a claim that every output is a joint angle <Cite id="helix-2025" />.
