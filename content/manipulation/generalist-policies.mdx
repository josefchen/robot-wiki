...
<Callout variant="warn" title="Vendor-reported is not verified">
  The timeline is a selected reading list, not a census of papers or independent replications. Attribute an announcement’s numerical claims to its issuer; an announcement is not independent verification.
</Callout>
