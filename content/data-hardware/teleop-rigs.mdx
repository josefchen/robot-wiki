...
Where this data goes next, and what it can and cannot teach a policy, continues in [Major Datasets](/data-hardware/datasets). The arms and sensors these rigs attach to are cataloged in [Hardware Taxonomy](/data-hardware/hardware-taxonomy), and what demonstrations become inside a policy starts at [Behavior Cloning Foundations](/manipulation/bc-foundations).
