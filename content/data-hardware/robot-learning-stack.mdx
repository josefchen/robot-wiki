...
Stress one factor at a time. LIBERO-Plus showed that controlled visual and physical perturbations reveal robustness gaps hidden by standard benchmark averages <Cite id="libero-plus-2025" />. Your suite should likewise separate lighting, distractors, object pose, camera pose, friction and instruction changes.
