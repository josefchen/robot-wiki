...
Where the trials come from is the data story: [The Data Bottleneck](/data-hardware/data-bottleneck) covers the hour-count arithmetic behind every rollout budget, and [Teleoperation Rigs](/data-hardware/teleop-rigs) covers the machines that produce the attempts. The training-side version of compounding, prediction error accumulating step by step, is [Behavior Cloning Foundations](/manipulation/bc-foundations).
