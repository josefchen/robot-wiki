...
All four figures are vendor-reported: the Helix 02 numbers from Figure's announcement <Cite id="helix-02-2026" /> and the Gemini Robotics 2 numbers from DeepMind's announcement <Cite id="gemini-robotics-2-2026" />.
