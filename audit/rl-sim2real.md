...
| "On-policy updates are the more stable and less hyperparameter-sensitive of the two" | No citation attached; checked ppo-2017, sac-2018, rudin-2021, haarnoja-walk-2019 | **unresolved** | No source cited in this article states an on-policy-versus-off-policy stability or hyperparameter-sensitivity comparison. Nearest support is sac-2018's "in contrast to other off-policy algorithms, our approach is very stable", which is about SAC versus other off-policy methods, and ppo-2017's stated advantage over TRPO, not over off-policy methods. Left as written rather than manufacture support; flagged as an uncited comparative claim needing either a source or a demotion to framing. |
