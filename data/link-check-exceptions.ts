...
export const LINK_CHECK_EXCEPTIONS: LinkCheckException[] = [
  ...
  },
  {
    ...
    verifiedBy:
      'Native check:citations --id symbotic-10k-2025 --json observed direct HTTP 200 with HTML title "sym-20250927" on 2026-09-23T00:36:40.889288Z. Separately rechecked the actual retained web fetch response from 2026-09-12T21:03:19.099Z at that exact accession URL: cover "FORM 10-K", "For the fiscal year ended September 27, 2025", "SYMBOTIC INC.". Retained symbotic-fetch-result.txt: 579888 bytes, SHA256 b7f7f0a7cdbd4eacff3520b4ca7f25f91e64cf49f3fc0e1907727d93088cb32b; original response event f1f1a06e, exact path in audit/citations.md. Its 200 is tool-reported; origin headers/redirects were not exposed. Current HTTP status comes from the native checker. This is document identity, not independent corroboration of company results or a new claim audit.',
    verifiedOn: '2026-09-23',
  },
  {
  ...
  },
  {
    ...
    verifiedBy:
      'Independent fetch on 2026-08-18 (web fetch, 200): full essay text served at the exact capture URL, title "The Bitter Lesson", author Rich Sutton, dated March 13, 2019, matching the registry entry.',
    verifiedOn: '2026-08-18',
  },
